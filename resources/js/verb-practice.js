...
var throwAway = new Verb('捨てる' , 'すてる' , 2 , '捨' , 'to throw away' , 'basic');
var drink = new Verb('飲む' , 'のむ' , 1 , '飲' , 'to drink' , 'basic');
var send = new Verb('送る' , 'おくる' , 1 , '送' , 'to send' , 'basic');
var see = new Verb('見る' , 'みる' , 2 , '見' , 'to see' , 'basic');
var existInanimate = new Verb('ある' , 'ある' , 1 , '×' , 'to exist (animate objects)' , 'basic');
var existAnimate = new Verb('いる' , 'いる' , 2 , '×' , 'to exist (inanimate objects)' , 'basic');
var doit = new Verb('する' , 'する' , 3 , '×' , 'to do' , 'basic');
var holdEvent = new Verb('行う' , 'おこなう' , 1 , '行' , 'to hold (an event)' , 'basic');
var go = new Verb('行く' , 'いく' , 1 , '行' , 'to go' , 'basic');
var make = new Verb('作る' , 'つくる' , 1 , '作' , 'to make' , 'basic');
var begin = new Verb('始まる' , 'はじまる' , 1 , '始' , 'to begin' , 'basic');
var wakeUp = new Verb('起きる' , 'おきる' , 2 , '起' , 'to wakeUp' , 'basic');
var continueit = new Verb('続く' , 'つづく' , 1 , '続' , 'to continue' , 'basic');
var stop = new Verb('止まる' , 'とまる' , 1 , '止' , 'to stop' , 'basic');
var stayOver = new Verb('泊まる' , 'とまる' , 1 , '泊' , 'to stop; to stay (over)' , 'basic');
var quit = new Verb('辞める' , 'やめる' , 2 , '辞' , 'to quit' , 'basic');
var finish = new Verb('終わる' , 'おわる' , 1 , '終' , 'to finish' , 'basic');
var proceed = new Verb('進む' , 'すすむ' , 1 , '進' , 'to proceed' , 'basic');
var beLate = new Verb('遅れる' , 'おくれる' , 2 , '遅' , 'to be late' , 'basic');
var increase = new Verb('増える' , 'ふえる' , 2 , '増' , 'to increase' , 'basic');
var decrease = new Verb('減る' , 'へる' , 1 , '減' , 'to decrease' , 'basic');
var remain = new Verb('残る' , 'のこる' , 1 , '残' , 'to remain' , 'basic');
var handOver = new Verb('渡す' , 'わたす' , 1 , '渡' , 'to hand over' , 'basic');
var enter = new Verb('入る' , 'はいる' , 1 , '入' , 'to enter' , 'basic');
var putIn = new Verb('入れる' , 'いれる' , 2 , '入' , 'to putIn' , 'basic');
var returnHome = new Verb('帰る' , 'かえる' , 1 , '帰' , 'to return (home)' , 'basic');
var answer = new Verb('答える' , 'こたえる' , 2 , '答' , 'to answer' , 'basic');
var appear = new Verb('現れる' , 'あらわれる' , 2 , '現' , 'to appear' , 'basic');
var meet = new Verb('会う' , 'あう' , 1 , '会' , 'to meet' , 'basic');
var open = new Verb('開ける' , 'あける' , 2 , '開' , 'to open' , 'basic');
var close = new Verb('閉める' , 'しめる' , 2 , '閉' , 'to close' , 'basic');
var receive = new Verb('もらう' , 'もらう' , 1 , '×' , 'to receive' , 'basic');
var take = new Verb('取る' , 'とる' , 1 , '取' , 'to take' , 'basic');
var search = new Verb('探す' , 'さがす' , 1 , '探' , 'to search' , 'basic');
var pickUp = new Verb('拾う' , 'ひろう' , 1 , '拾' , 'to pick up' , 'basic');
var fall = new Verb('落ちる' , 'おちる' , 2 , '落' , 'to fall' , 'basic');
var drop = new Verb('落とす' , 'おとす' , 1 , '落' , 'to drop' , 'basic');
var use = new Verb('使う' , 'つかう' , 1 , '使' , 'to use' , 'basic');
var passBy = new Verb('通る' , 'とおる' , 1 , '通' , 'to pass by' , 'basic');
var hurry = new Verb('急ぐ' , 'いそぐ' , 1 , '急' , 'to hurry' , 'basic');
var wait = new Verb('待つ' , 'まつ' , 1 , '待' , 'to wait' , 'basic');
var call = new Verb('呼ぶ' , 'よぶ' , 1 , '呼' , 'to call' , 'basic');
var place = new Verb('置く' , 'おく' , 1 , '置' , 'to place' , 'basic');
var know = new Verb('知る' , 'しる' , 1 , '知' , 'to know' , 'basic');
var understand = new Verb('分かる' , 'わらる' , 1 , '分' , 'to understand' , 'basic');
var collect = new Verb('集まる' , 'あつまる' , 1 , '集' , 'to collect' , 'basic');
var extend = new Verb('広がる' , 'ひろがる' , 1 , '広' , 'to extend' , 'basic');
var attach = new Verb('付く' , 'つく' , 1 , '付' , 'to attach' , 'basic');
var breakit = new Verb('壊れる' , 'こわれる' , 2 , '壊' , 'to break' , 'basic');
var fix = new Verb('直る' , 'なおる' , 1 , '直' , 'to fix' , 'basic');
var takeOff = new Verb('脱ぐ' , 'ぬぐ' , 1 , '脱' , 'to take off (clothes)' , 'basic');
var examine = new Verb('調べる' , 'しらべる' , 2 , '調' , 'to examine' , 'basic');
var sit = new Verb('座る' , 'すわる' , 1 , '座' , 'to sit' , 'basic');
var stand = new Verb('立つ' , 'たつ' , 1 , '立' , 'to stand' , 'basic');
var sell = new Verb('売る' , 'うる' , 1 , '売' , 'to sell' , 'basic');
var arrive = new Verb('着く' , 'つく' , 1 , '着' , 'to arrive' , 'basic');
var sing = new Verb('歌う' , 'うたう' , 1 , '歌' , 'to sing' , 'basic');
var read = new Verb('読む' , 'よむ' , 1 , '読' , 'to read' , 'basic');
var laugh = new Verb('笑う' , 'うしなう' , 1 , '笑' , 'to laugh' , 'basic');
var walk = new Verb('歩く' , 'あるく' , 1 , '歩' , 'to walk' , 'basic');
var hear = new Verb('聞く' , 'きく' , 1 , '聞' , 'to hear' , 'basic');
var learn = new Verb('習う' , 'ならう' , 1 , '習' , 'to learn' , 'basic');
var consider = new Verb('考える' , 'かがえる' , 2 , '考' , 'to consider' , 'basic');
var sleep = new Verb('寝る' , 'ねる' , 2 , '寝' , 'to sleep' , 'basic');
var teach = new Verb('教える' , 'おしえる' , 2 , '教' , 'to teach' , 'basic');
var come = new Verb('来る' , 'くる' , 3 , '来' , 'to come' , 'basic');
var do2 = new Verb('やる' , 'やる' , 1 , 'や' , 'to do' , 'basic');
var say = new Verb('言う' , 'いう' , 1 , '言' , 'to say' , 'basic');
var think = new Verb('思う' , 'おもう' , 1 , '思' , 'to think' , 'basic');
var show = new Verb('示す' , 'しめす' , 1 , '示' , 'to show' , 'basic');
var mix = new Verb('混ぜる' , 'まぜる' , 2 , '混' , 'to mix' , 'basic');
var wear = new Verb('着る' , 'きる' , 2 , '着' , 'to wear' , 'basic');
var wash = new Verb('洗う' , 'あらう' , 1 , '洗' , 'to wash' , 'basic');
var grill = new Verb('焼く' , 'やく' , 1 , '焼' , 'to grill' , 'basic');
var win = new Verb('勝つ' , 'かつ' , 1 , '勝' , 'to win' , 'basic');
var lose = new Verb('負ける' , 'まける' , 2 , '負' , 'to lose' , 'basic');
var forget = new Verb('忘れる' , 'わすれる' , 2 , '忘' , 'to forget' , 'basic');
var remember = new Verb('覚える' , 'おぼえる' , 2 , '覚' , 'to remember' , 'basic');
var turn = new Verb('曲がる' , 'まがる' , 1 , '曲' , 'to turn' , 'basic');
var ride = new Verb('乗る' , 'のる' , 1 , '乗' , 'to ride' , 'basic');
var protect = new Verb('守る' , 'まもる' , 1 , '守' , 'to protect' , 'basic');
var feel = new Verb('感じる' , 'かんじる' , 2 , '感' , 'to feel' , 'basic');
var live = new Verb('生きる' , 'いきる' , 2 , '生' , 'to live' , 'basic');
var goUp = new Verb('上がる' , 'あがる' , 1 , '上' , 'to go up' , 'basic');
var goDown = new Verb('下がる' , 'さがる' , 1 , '下' , 'to go down' , 'basic');
